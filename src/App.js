...
function App() {
  ...
  const [feedback, setFeedback] = useState("What Robot will you get?");
  ...
  const claimNFTs = (_amount) => {
    ...
    setFeedback("Your Robot is now on NFT Factory...");
    setClaimingNft(true);
    blockchain.smartContract.methods
      ...
      .then((receipt) => {
        setFeedback(
          "Woohoo! You just mint a Robot ! Visit Opensea.io to view your randomly generated NFT!"
        );
        setClaimingNft(false);
            ...
            {Number(data.totalSupply) == 10000 ? (
              <>
                ...
                <s.TextDescription style={{ textAlign: "center" }}>
                  You can buy robots NFT from people{" "}
